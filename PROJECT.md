...
0. **Walk into the School.** PR B's gate. The dev menu has *Walk into Pine
   ...
   friend who died in there feel right. Then PR C, the phase boss, once the
   dash (PR A) has been felt.
