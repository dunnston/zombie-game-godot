...
| Unit tests | 362 tests, 4989 assertions (`tools\test.cmd`). `--all` adds the compound raid harness, the save round trips, the fire spread trials and the survivor combat tests: 392 tests, 5102 assertions. Wall-clock varies with the machine — see §9 |
