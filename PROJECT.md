...
| Unit tests | 307 tests, 4410 assertions (`tools\test.cmd`). `--all` adds the compound raid harness, the save round trips, the fire spread trials and the survivor combat tests: 337 tests, 4523 assertions. Wall-clock varies with the machine — see §9 |
...
```
tests: 307  asserts: 4410  failures: 0
tests: 337  asserts: 4523  failures: 0   (--all)
